<template>
  ...
  <div class="col-md-9 panel panel-default">
   ...
   <div class="col-md-9 panel panel-default">
    <d3dependency-graph class="graph-root" ref="graph" :identifier="getId" :data="forDependency.tree" :links="forDependency.links" :node-text="nodeText"  :margin-x="Marginx" :margin-y="Marginy"></d3dependency-graph>
  </div>
